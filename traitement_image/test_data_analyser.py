...
def test_return_the_top_three_matching_names_for_a_line():
    results = data_analyser.return_the_top_three_matching_names_for_a_line("cottowood")
    assert results["matching_name"][0] == "cottonwood"
    assert results["statut"][0] == "ABONNE"
    assert results["correspondance_rate"][0] > 90
    
def test_return_none_if_no_matching_name():
    results = data_analyser.return_the_top_three_matching_names_for_a_line("")
