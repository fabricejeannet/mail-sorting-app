...
REGEX_GENDER_MARKERS = r'\b(m\b\.?|mme\b\.?|mr\b\.?|madame\b|monsieur\b)'
...
LEGAL_STATUS = [REGEX_SARL, REGEX_SASU, REGEX_EURL, REGEX_SCI, REGEX_SNC, REGEX_EIRL, REGEX_CABINET, REGEX_STE, REGEX_SOCIETE, REGEX_SAS, REGEX_EI]
