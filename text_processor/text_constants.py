...
BANNED_WORDS_LIST = ["33000 bordeaux", "coolworking", "9 rue de conde", "rue de conde","9 rue conde","titulaire du compte", "representant legal", "facture n" , "retour à" ,"destinataire lettre","bureau 3", "destinataire", "numero de tva", "numero de siret", "ecopli", "etage 3", "niveau de garantie", "numero de police", "numero de contrat", "numero de telephone", "numero de fax", "numero de compte", "numero de client", "numero de facture", "numero de commande", "numero de dossier", "\\x0c"]
