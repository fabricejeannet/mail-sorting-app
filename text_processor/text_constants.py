...
REGEX_SARLU = r'(?<!\w)(?:\(?[sS]\.?[aA]\.?[rR]\.?[lL]\.?[uU]\b\.?\)?)(?!\w)'
REGEX_SELARL = r'(?<!\w)(?:\(?[sS]\.?[eE]\.?[lL]\.?[aA]\.?[rR]\.?[lL]\.?\)?)(?!\w)'
...
LEGAL_STATUS = [REGEX_SARLU, REGEX_SARL, REGEX_SELARL ,REGEX_SASU, REGEX_EURL, REGEX_SCI, REGEX_SNC,REGEX_GROUPE, REGEX_EIRL, REGEX_CABINET, REGEX_STE, REGEX_SOCIETE, REGEX_ENTREPRISE, REGEX_SAS, REGEX_EI, REGEX_CIE]
