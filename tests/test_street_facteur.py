...
def test_show_valid_image_on_full_match():
    ...
    mock_clients = [client1, client2, client3]
    street_facteur.matching_results = [mock_clients]
    assert street_facteur.show_the_good_image_depending_on_the_result() == "valid"
...
def test_show_warning_if_all_valid_but_no_match_with_a_good_matching_rate():
    ...
    mock_clients = [client1, client2, client3]
    street_facteur.matching_results = [mock_clients]
    assert street_facteur.show_the_good_image_depending_on_the_result() == "warning"
...
def test_no_match_found_with_higher_rate_than_threshold():
    ...
    mock_clients = [client1, client2, client3]
    street_facteur.matching_results = [mock_clients]
    assert street_facteur.show_the_good_image_depending_on_the_result() == "invalid"
...
def test_reorder_results_to_show_the_most_corresponding_result_first():
    ...
    assert street_facteur.matching_results[0][0].correspondance_ratio == VALID_CORRESPONDANCE_RATE_THRESHOLD + 4
    ...
    street_facteur.matching_results = [mock_clients1, mock_clients2]
    street_facteur.reorder_results_to_show_the_most_corresponding_result_first()
    assert street_facteur.matching_results[0][0].correspondance_ratio == VALID_CORRESPONDANCE_RATE_THRESHOLD + 10
